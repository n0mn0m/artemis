...
use crate::configuration::config::{Logging, IpRateLimiting, LogLevel, IpRateLimitPolicies, Aws, JwtToken};
...
fn get_test_config() -> Config {
 Config {
    ...
    logging: Logging { log_level: LogLevel { default: "".to_string() } },
    jwt_token: JwtToken {
        audience: "".to_string(),
        issuer: "".to_string()
    },
    ...
    aws: Aws { region: "us-east-1".to_string(), secret_name: "test-foo".to_string() }
}
}
